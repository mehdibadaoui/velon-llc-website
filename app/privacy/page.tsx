    ...
    <div className="py-20 bg-white">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <section className="mb-12">
            <h2 className="text-3xl font-bold mb-4 text-gray-900">4. How We Share Your Information</h2>
            <p className="text-gray-700 mb-4">
              We may share your information in the following circumstances:
            </p>
            <ul className="list-disc pl-6 mb-4 text-gray-700 space-y-2">
              <li><strong>Service Providers:</strong> We may share information with third-party service providers who perform services on our behalf (e.g., payment processors, hosting providers, analytics services)</li>
          ...
          <section className="mb-12">
            <h2 className="text-3xl font-bold mb-4 text-gray-900">6. Data Retention</h2>
            <p className="text-gray-700 mb-4">
          ...
          <section className="mb-12">
            <h2 className="text-3xl font-bold mb-4 text-gray-900">7. Your Rights and Choices</h2>
            <p className="text-gray-700 mb-4">
          ...
          <section className="mb-12">
            <h2 className="text-3xl font-bold mb-4 text-gray-900">8. Cookies and Tracking Technologies</h2>
            <p className="text-gray-700 mb-4">
          ...
          <section className="mb-12">
            <h2 className="text-3xl font-bold mb-4 text-gray-900">9. Third-Party Links</h2>
            <p className="text-gray-700 mb-4">
          ...
          <section className="mb-12">
            <h2 className="text-3xl font-bold mb-4 text-gray-900">10. Children's Privacy</h2>
            <p className="text-gray-700 mb-4">
          ...
          <section className="mb-12">
            <h2 className="text-3xl font-bold mb-4 text-gray-900">12. Changes to This Privacy Policy</h2>
            <p className="text-gray-700 mb-4">
